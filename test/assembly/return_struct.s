...
# options passed:  -imultilib . -imultiarch i386-linux-gnu return_struct.c
# -mtune=generic -march=i686 -fverbose-asm -fstack-protector
...
.LFB1:
	...
	call	f	#
	subl	$4, %esp	#,
	movl	-16(%ebp), %eax	# y.a, tmp61
	movl	%eax, -8(%ebp)	# tmp61, a
	movl	-12(%ebp), %eax	# y.b, tmp62
	movl	%eax, -4(%ebp)	# tmp62, b
	leave
	ret
.LFE1:
	.size	main, .-main
